    ...
    try:
        ...
        if len(periodic_table_type_list) == 0:
            ...
            url_file = finders.find(
                join("core_explore_periodic_table_app", "common", "xsd", XSD_FILENAME)
            )
            ...
            type_version_manager = type_version_manager_api.insert(
                type_version_manager, type_object, []
            )
