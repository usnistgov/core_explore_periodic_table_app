...
@extend_schema(
    tags=["Search Operators Mapping"],
    description="List the Search Operators Mapping",
)
class SearchOperatorsMapping(APIView):
    ...
    @extend_schema(
        summary="Get all search operator mappings",
        description="Get all the search operator mapping object",
        responses={
            200: SearchOperatorMappingSerializer(many=True),
    ...
    @extend_schema(
        summary="Create a new search operator mapping",
        description="Create a search operator mapping",
        request=SearchOperatorMappingSerializer,
        responses={
            201: SearchOperatorMappingSerializer,
            400: OpenApiResponse(
                description="Validation error / not unique / model error"
            ),
            404: OpenApiResponse(description="Search operator not found"),
            500: OpenApiResponse(description="Internal server error"),
        },
    )
...
@extend_schema(
    tags=["Search Operators Mapping"],
    description="Search operator mapping detail",
)
class SearchOperatorMappingDetail(APIView):
    ...
    @extend_schema(
        summary="Retrieve a search operator mapping",
        description="Retrieve search operator mapping from database",
        parameters=[
            OpenApiParameter(
                name="id",
                type=OpenApiTypes.STR,
                location=OpenApiParameter.PATH,
                description="Search operator mapping ID",
            ),
        ],
        responses={
            200: SearchOperatorMappingSerializer,
    ...
    @extend_schema(
        summary="Update a search operator mapping",
        description="Update a search operator mapping",
        parameters=[
            OpenApiParameter(
                name="id",
                type=OpenApiTypes.STR,
        ...
        examples=[
            OpenApiExample(
                ...
                description="Example request body for updating a search operator mapping",
                value={"search_operator_id": "<search_operator_id>"},
            ),
        ],
    )
    ...
    @extend_schema(
        summary="Delete a search operator mapping",
        description="Delete a search operator mapping",
        parameters=[
            OpenApiParameter(
                name="id",
                type=OpenApiTypes.STR,
