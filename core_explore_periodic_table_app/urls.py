...
urlpatterns = [
    ...
    url(
        r"^(?P<template_id>\w+)/(?P<query_id>\w+)$",
        PeriodicTableBuildQueryView.as_view(),
        name="core_explore_periodic_table_index",
    ),
    url(
        r"^save-query$",
        user_ajax.PeriodicTableSaveQueryView.as_view(
    ...
    url(
        r"^get-query-values$",
        user_ajax.get_query_values,
        name="core_explore_periodic_table_get_query_values",
    ),
    url(
        r"^submit-query$",
        user_ajax.submit_query,
        name="core_explore_periodic_table_submit_query",
    ),
]
