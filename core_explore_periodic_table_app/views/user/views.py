...
class PeriodicTableBuildQueryView(TypeBuildQueryView):
    ...
    data_sources_selector_template = (
        "core_explore_periodic_table_app/user/selector/data_sources_selector.html"
    )
    ...
    def get(self, request, template_id=None, query_id=None):
        ...
        return super(PeriodicTableBuildQueryView, self).get(
            request, template_id, query_id
        )
    ...
    def _get_css():
        ...
        """
        base_css = super(
            PeriodicTableBuildQueryView, PeriodicTableBuildQueryView
        )._get_css()
        # Add custom css
        base_css.extend(
